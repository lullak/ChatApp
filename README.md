...
- Encrypted messages use the format: `ENC:<ivBase64>:<cipherBase64>`.
- Client -> Encrypt - > Server decrypt -> stores payload -> encrypt -> clients decrypt.
- sanitize with DOMPurify "client" and HtmlSanitizer "Server" .
